...
class CommonRequestDescriptorsMixin(object):
    ...
    content_type = environ_property('CONTENT_TYPE', doc='''
        ...
        the entity-body sent to the recipients or, in the case of the HEAD
    ...
    def pragma(self):
        ...
        implementation-specific directives that might apply to any recipients
...
class CommonResponseDescriptorsMixin(object):
    ...
    location = header_property('Location', doc='''
        The Location response-header field is used to redirect the recipients
    ...
    content_type = header_property('Content-Type', doc='''
        ...
        entity-body sent to the recipients or, in the case of the HEAD method,
        the media type that would have been sent had the request been a GET.
    ''')
    content_length = header_property('Content-Length', None, int, str, doc='''
        The Content-Length entity-header field indicates the size of the
        entity-body, in decimal number of OCTETs, sent to the recipients or,
    ...
    allow = _set_property('Allow', doc='''
        ...
        field is strictly to inform the recipients of valid methods
